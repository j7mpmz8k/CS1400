...
hero_size = int(input("...Size: "))#diameter
hero_x_location = int(input("...X Location(0-100 left to right): "))
hero_y_location = int(input("...Y Location(0-100 bottom to top): "))
...
while overlap > 0:
    ...
    villain_size = int(input("...Body Size: "))#diameter
    villain_x_location = int(input("...X Location(0-100 left to right): "))
    villain_y_location = int(input("...Y Location(0-100 left to right): "))
...
drawly.start(title=f"{hero_name} vs {villain_name}", dimensions=(x_pixels, y_pixels),
             terminal=True, terminal_lines=1, terminal_line_height=100)
drawly.set_speed(9)
